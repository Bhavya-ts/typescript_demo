...
// const userModel = require(" s../models/user");
import { project } from "../models/project.js";
import { roleModel } from "../models/role.js";
export var sigin = function (req, res, next) {
      ...
      switch (_b.label) {
        case 0:
          ...
          if (!email || !password) {
            return [
              2 /*return*/,
              res.status(400).send("Please entre a email and password"),
            ];
          }
          //validate email
...
export var showPerticcularProject = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
